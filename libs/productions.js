...
/*
 * Get the task type priority of a task type in a given production
 * @param {Object} taskType The task type object
 * @param {Object} production The production object
 * @returns {Number} The task type priority
 */
export const getTaskTypePriorityOfProd = (taskType, production) => {
  if (!taskType) {
    return 1
  } else if (
    production &&
