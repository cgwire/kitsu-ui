...
<div>
  ...
  >
    ...
    <div class="select-input" ref="select-input" v-show="showList">
      <div
        :key="option.id"
...
export default {
  ...
  mounted() {
    ...
    this.$refs['select-input'].style.minWidth =
      `${this.$refs.select.offsetWidth}px`
    this.$refs['select-input'].style.height =
      `${this.options.length * 36}px`
  },
